...
/**
 * Created by sanyinchen on 19-10-8.
 *
 * @author sanyinchen
 * @version v0.1
 * @since 19-10-8
...
class Friend_circles_547 {
    ...
    public static void main(String[] args) {
        //  int[][] inpust = new int[][]{{1, 0, 0}, {0, 1, 0}, {0, 0, 1}};
        int[][] inpust = new int[][]{{1, 1, 0}, {1, 1, 0}, {0, 0, 1}};

        System.out.println("==>" + new Solution().findCircleNum(inpust));
    }
}
